...
public final class MaskingCommon {
    ...
    public static final Set<String> KEYS_TO_MASK_LOWERCASE = (Set) Stream.of("id_token", "client_secret", "Authorization", "password", "passwort", "pwd", "passwd", "oldpassword", "newpassword", "client_secret", "secret", "credential", "otp", "vouchercode", "voucher-code", "vouchercodes", "voucher-codes", "wlankey", "api_key", "client_id", "client_secret", "token", "access_token", "refresh_token", "couponCode", "trustCode", "nts-user-pass", "Set-Cookie", "X-Csrf-Token").map(String::toLowerCase).collect(Collectors.toUnmodifiableSet());
