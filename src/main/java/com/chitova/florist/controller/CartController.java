...
public class CartController {
    ...
    public ResponseEntity<UpdateCartResponse> checkout(@RequestBody final CheckoutCartRequest request,
    ...
    public ResponseEntity<UpdateCartResponse> updateCart(@RequestBody final UpdateCartRequest request) {
